...
public class JobOffreRepositoryImpl implements JobOffreRepository {
    ...
    public List<JobOffer> findAll() {
        ...
        try {
            ...
            throw new RuntimeException("Error retrieving job offers", e);
        } finally {
            if (entityManager != null && entityManager.isOpen()) {
                entityManager.close();
            }
    ...
    public JobOffer update(JobOffer jobOffer) {
        ...
        try {
            ...
            if (existingJobOffer != null) {
                ...
                System.out.println("The job offer with the ID " + jobOffer.getId() + " does not exist.");
                return null;
            }
        } catch (Exception e) {
            if (entityManager != null && entityManager.getTransaction().isActive()) {
            ...
            throw new RuntimeException("Error updating job offer", e);
        } finally {
            if (entityManager != null && entityManager.isOpen()) {
                entityManager.close();
            }
