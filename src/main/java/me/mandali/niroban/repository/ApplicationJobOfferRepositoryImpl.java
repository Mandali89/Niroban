...
import me.mandali.niroban.repository.interfaces.ApplicationJobOfferRepository;
...
public class ApplicationJobOfferRepositoryImpl implements ApplicationJobOfferRepository {
    ...
    public ApplicationJobOfferRepositoryImpl() {
        this.entityManager = Persistence.createEntityManagerFactory("niroban").createEntityManager();
    }
