...
import me.mandali.niroban.repository.JobOffreRepositoryImpl;
...
import me.mandali.niroban.service.JobOffreServiceImpl;
import me.mandali.niroban.service.RecruiterServiceImpl;
...
public class JobOfferServlet extends HttpServlet {
    ...
    private JobOffer extractJobOfferFromRequest(HttpServletRequest request) {
        try {
            ...
            String recruiterIdParam = request.getParameter("recruiter_id");
            if (recruiterIdParam != null && !recruiterIdParam.isEmpty()) {
                try {
                    recruiterId = Long.parseLong(recruiterIdParam);
                } catch (NumberFormatException e) {
                    throw new InvalidInputException("Invalid recruiter ID format.");
                }
            }
            ...
            throw new InvalidInputException("Invalid date format: " + e.getMessage());
        }
    }
}