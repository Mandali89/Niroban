...
<head>
    ...
    <title>ویرایش پیشنهاد شغلی</title>
    ...
    <form action="joboffre" method="post">
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="form-control" required>
                <option value="Open" ${jobOffer.status == 'Open' ? 'selected' : ''}>باز</option>
                <option value="Closed" ${jobOffer.status == 'Closed' ? 'selected' : ''}>بسته</option>
            </select>
        </div>
        <div class="form-group">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-edit"></i> به‌روزرسانی پیشنهاد شغلی
            </button>
        </div>
    </form>
    <div>
